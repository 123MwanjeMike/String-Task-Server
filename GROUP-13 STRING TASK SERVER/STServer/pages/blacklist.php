          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Blacklisted Jobs <small>Detailed information about the blacklisted tasks</small></h3>
              </div>
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-striped">
                      <thead>
                        <tr>
                          <th>JobID</th>
                          <th>Job Characters</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php 
 require './php/config.php';
$result = mysqli_query($con, "SELECT * FROM Black_list") or die(mysqli_error($con));
