          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Client Logs <small>Detailed Information about client submissions</small></h3>
              </div>
...
$result = mysqli_query($con, "SELECT * FROM Logs") or die(mysqli_error($con));
