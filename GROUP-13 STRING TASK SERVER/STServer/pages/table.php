            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <l<li><a><i class="fa fa-table"></i> Jobs <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-bar-chart-o"></i> Task Information <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="process_rate.php">Average Processing Rate</a></li>
...
$result = mysqli_query($con, "SELECT * FROM ready_list") or die(mysqli_error($con));
