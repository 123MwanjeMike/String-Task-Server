                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> Jobs <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="busy.php">Busy_List</a></li>
                      <li><a href="priorities.php">Priority Information</a></li>
                  ...
                  <li><a><i class="fa fa-bar-chart-o"></i> Task Information <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="failure.php">Failure Rate</a></li>
                    </ul>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">Michael Arikosi
...
$result = mysqli_query($con, "SELECT ClientIP,FailureRate FROM trial ORDER BY FailureRate DESC") or die(mysqli_error($con));
