          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Process History <small>Client with the highest success rate</small></h3>
              </div>
...
$result = mysqli_query($con, "SELECT ClientIP,SuccessRate FROM trial2 ORDER BY SuccessRate DESC") or die(mysqli_error($con));
